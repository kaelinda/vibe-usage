...
### Modified: PlatformForm API Key Handling

**Previous Behavior:** API key was optional in form submission
**New Behavior:** API key **MUST** be required for new platform additions

#### Scenario: API Key Required for New Platform
**Given** the PlatformForm in add mode
**When** the user attempts to submit without an API key
**Then** the form shall show "API key is required" error
...
- **Related Capability:** `model-management` - Models are associated with platforms
- **Related Capability:** `usage-tracking` - Usage records link to models and platforms
